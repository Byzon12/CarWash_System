...
from .views import RegisterUserView, ListUserView, LoginUserView, CustomerProfileView, PasswordResetView, PasswordResetConfirmView, PasswordChangeView, LogoutUserView
