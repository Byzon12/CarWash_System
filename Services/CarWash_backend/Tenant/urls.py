...
from .views import TenantProfileView, TenantLoginView, TenantLogoutView, CreateEmployeeView, ListEmployeeView, CreateEmployeeSalaryView, DeleteEmployeeView, DeactivateEmployeeView
